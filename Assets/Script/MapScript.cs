...
public class MapScript : MonoBehaviour
{
    ...
    public float lat = 6.245731f; //Insert your desired latitude
    public float lon = -75.572099f; //Insert your desired longitude
    public int zoom = 14;
    ...
    IEnumerator GetGoogleMap(float lat, float lon)
    {
        url = "https://maps.googleapis.com/maps/api/staticmap?center=" + lat + "," + lon +
            ...
            + "&maptype=" + mapSelected +
            "&key=AIzaSyCcNSbdf-y8BcE-EiftxuwFcQPQ4V4cwo4";
        loadingMap = true;
